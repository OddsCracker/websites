...
<div id="center-col" class="col-sm-6">
	...
	<?php
		$market_labels = array('1x2'=>'1x2 odds', 'dc'=>'Double Chance', 'cs'=>'Correct Score', 'bts'=>'Both Teams to Score', 'ou'=>'Over/Under', 'oe'=>'Odd/Even', 'tg'=>'Total Goals', 'ht-ft'=>'Half Time/Full Time', 'ht-cs'=>'Half Time Correct Score', 'fh-1x2'=>'First Half 1x2', 'eh'=>'Handicap');
		$markets = array();
		...
		echo '
				<li class="dropdown hidexs pull-right">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">More bets <i class="fa fa-lg fa-angle-down"></i></a>
