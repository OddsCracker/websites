...
<div id="center-col" class="col-sm-6">
	...
	if ( !$today_events ) {
	?>
	<h2 class="up-next"><i class="fa fa-lg fa-angle-double-right"></i> Today's betting odds</h2>
	<h3 class="text-center">No betting events scheduled for today</h3>
	<?php
		if ($next_events) {
		?>
		<h2 class="up-next"><i class="fa fa-lg fa-angle-double-right"></i> Next betting odds</h2>
	...
	?>
		...
		<?php if ($best) { ?>
			<p class="best-odds-title">Best Betting Odds</p>
		...
		?>
		<h2 class="up-next"><i class="fa fa-lg fa-angle-double-right"></i> Tomorrow's betting odds</h2>
		<table class="table table-striped">
			<tbody>
		<?php
		foreach ($next_events as $key => $value) {
...
?>
		...
		<div class="text-center">
			<a href="/events" title="All upcoming events" class="btn btn-lg btn-success">All upcoming betting odds <i class="fa fa-lg fa-angle-double-right"></i></a>
		</div>
		<br>
<?php
		}
