	...
	public function reviews(){
		...
		if ($this->uri->segment(3)) {
			...
			if (!empty($bookmaker['MetaTitle'])) {
				...
				$this->data['page']['MetaTitle'] = $bookmaker['Name'] . '\'s review | ' . $this->data['settings']['site_name'] . ' ' . $this->data['settings']['country_name_name'];
				$this->data['page']['og:title'] = $bookmaker['Name'] . '\'s review | ' . $this->data['settings']['site_name'] . ' ' . $this->data['settings']['country_name_name'];
			}
