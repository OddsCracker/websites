...
class Cron extends MY_Controller {
	...
	public function update_news(){
		...
		/* footballghana.com */
 		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://footballghana.com/feed');
		...
		/* pulse.com.gh */
 		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.pulse.com.gh/sports/rss');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* goal.com */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.goal.com/en-gh/feeds/news');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* ghanaweb.com */
 		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://cdn.ghanaweb.com/feed/soccerfeed.xml');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* myjoyonline.com */
 		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.myjoyonline.com/pages/rss/site_sports.xml');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
