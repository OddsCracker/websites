...
?>
	...
	<body>
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						...
						<li class="hidesm dropdown">
							<a href="/" class="dropdown-toggle" title="Événements de paris d'aujourd'hui">Événements de paris d'aujourd'hui</a>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="/bookmakers/reviews" title="Classement et avis">Classement et avis</a></li>
								<li><a href="/bookmakers/comparison" title="Comparaison des fonctionnalités">Comparaison des fonctionnalités</a></li>
							</ul>
						</li>
						<li><a href="/jackpots" title="Jackpots">Jackpots</a></li>
						<li><a href="/archives" title="Les archives">Les archives</a></li>
						<li class="dropdown">
							<a class="dropdown-toggle" href="#" onclick="return false;">Lieues</a>
							<ul class="dropdown-menu">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						?>
						<li><a href="#" id="login-btn" title="S'identifier"><i class="fa fa-fw fa-unlock"></i> S'identifier</a></li>
						<li><a href="/register" title="S'inscrire"><i class="fa fa-fw fa-sign-in"></i> S'inscrire</a></li>
						<?php
						} else {
						?>
						<li><a href="/account" title="Mon compte"><i class="fa fa-fw fa-user"></i> Mon compte</a></li>
						<li><a href="#" id="logout-btn" title="Se déconnecter"><i class="fa fa-fw fa-lock"></i> Se déconnecter</a></li>
						<?php
						}
						?>
					</ul>
		...
		<div id="info-strip">
			...
			<h4 class="text-center"><a href="/faq" title="FAQ">Cliquez ici pour savoir comment gagner plus en utilisant ce site</a></h4>
		</div>
		<?php endif; ?>
				...
				<div class="col-sm-6">
					<div id="subscribe-wrapper">
						...
						<form method="post" class="form form-horizontal" accept-charset="UTF-8" action="https://www.aweber.com/scripts/addlead.pl">
							...
							<h4 class="text-center">Abonnez-vous pour obtenir les meilleures cotes de paris chaque jour</h4>
							<div class="form-group row">
								<div class="col-sm-6">
									<input class="form-control" id="awf_field-100301137" type="text" name="email" value="" tabindex="500" onfocus=" if (this.value == '') { this.value = ''; }" onblur="if (this.value == '') { this.value='';} " placeholder="Votre email">
								</div>
								<div class="col-sm-6">
									<input name="submit" class="btn btn-subscribe" type="submit" value="Soumettre" tabindex="501">
								</div>
							</div>
							<p class="text-center">Nous respectons la <a title="Privacy Policy" href="https://www.aweber.com/permission.htm" target="_blank" rel="nofollow">confidentialité du votre courrier électronique</a> - <a href="https://www.aweber.com" title="AWeber Email Marketing" target="_blank" rel="nofollow">Powered by AWeber Email Marketing</a></p>
						</form>
						<!-- /AWeber Web Form Generator 3.0.1 -->
					</div>
				</div>
					...
					<div class="event-search">
						<form id="event-search-form" class="form" method="post" onsubmit="return false;">
							<div class="input-group event-search-group">
								<input type="text" name="search" class="form-control event-search-input" placeholder="Recherche par équipe" autocomplete="off">
								<div class="input-group-btn">
									<button class="btn btn-default btn-event-search" type="Soumettre">
