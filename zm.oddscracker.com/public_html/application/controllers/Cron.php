...
class Cron extends MY_Controller {
	...
	public function update_news(){
		...
		/* zambianfootball.news */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.zambianfootball.news/feed/');
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://zambianfootball.co.zm/feed/');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* www.lusakatimes.com */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://www.lusakatimes.com/feed/');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
