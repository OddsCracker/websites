	...
	<table id="bookmakers_table" class="table table-bordered">
		<thead>
			<tr>
				<th>ID</th>
				<th>Order</th>
				<th class="text-center">Display odds</th>
				<th>Name</th>
				<th>Logo</th>
				<th>Rating</th>
				<th>Manage</th>
		...
		?>
			<tr>
				...
				<td class="text-center"><?php if ($value['DisplayOdds'] > 0) { echo '<i class="fa fa-fw fa-check text-success"></i>'; } else { echo '<i class="fa fa-fw fa-times text-danger"></i>'; } ?></td>
