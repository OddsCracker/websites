...
class Cron extends MY_Controller {
	...
	public function update_news(){
		...
		/* nilepost.co.ug */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://nilepost.co.ug/category/sports/feed/');
		...
		/* kawowo.com */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://www.kawowo.com/feed/');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* monitor.co.ug */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.monitor.co.ug/Sports/690254-690254-view-asFeed-rknahxz/index.xml');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* redpepper.co.ug */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://redpepper.co.ug/category/sports/feed/');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
		...
		/* fufa.co.ug */
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'http://www.fufa.co.ug/feed/');
		curl_setopt($ch, CURLOPT_TIMEOUT, 45);
		curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$res = curl_exec($ch);
